...
public class ModbusPointLocatorVO extends AbstractPointLocatorVO implements JsonSerializable {
	...
	public void testModbusPointLocator(ModbusMaster modbusMaster, boolean serial, DwrResponseI18n response) {
	    validate(response);
	    if (response.getHasMessages())
	        return;
	
	    try {
	        BaseLocator<?> bl = ModbusDataSource.createModbusLocator(this);
	        modbusMaster.init();
