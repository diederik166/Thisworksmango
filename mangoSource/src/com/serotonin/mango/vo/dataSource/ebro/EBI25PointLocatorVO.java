...
public class EBI25PointLocatorVO extends AbstractPointLocatorVO implements JsonSerializable {
	...
	@MethodFilter
	public DwrResponseI18n saveEBI25PointLocator(int id, String xid, String name, DataSourceEditDwr dataSourceEditDwr) {
	    DwrResponseI18n response = new DwrResponseI18n();
	
	    if (getType() == EBI25PointLocatorVO.TYPE_VALUE) {
	        ...
	        if (getSampleRate() < 1)
	            ...
	            LocalizableMessage errorMessage = new EBI25InterfaceUpdater().updateLogger(ds.getHost(), ds.getPort(),
	                    ds.getTimeout(), ds.getRetries(), this);
	
	            if (errorMessage == null) {
	                response = dataSourceEditDwr.validatePoint(id, xid, name, this, new DataPointDefaulter() {
	                    @Override
	        ...
	        response = dataSourceEditDwr.validatePoint(id, xid, name, this, null);
